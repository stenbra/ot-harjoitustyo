...
sequenceDiagram
  ...
  note right of CardComparer: this will happen twice since 2 cards are played per player each round
  ...
  note right of Turnhandler: this will happen twice since 2 cards are played per player each round
