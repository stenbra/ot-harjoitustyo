...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_jos_raha_vain_edullisen_lounan_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")
    
    def test_syo_maukkaasti_jos_raha_vain_maukkaasti_lounan_verran(self):
    ...
    def test_kortille_ei_voi_ladata_negatiivinen_arvon(self):
